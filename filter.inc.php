...
class Filter
{
    ...
    {
        $this->AddFilter($token);
        $this->LoadSaveFilter($token);
        $this->ActiveFilters($token);
        $this->StatisticsFilters($token);
        $this->LinksReports($token);
    }

    public function ActiveFilters($token)
    {
        include_once "./components/active_filters.php";  
    }
    public function AddFilter($token)
    {
        include_once "./components/add_filters.php";  
    }
    public function LoadSaveFilter($token)
    {
        include_once "./components/load_save_filters.php";  
    }
    public function StatisticsFilters($token)
    {
        $query = "
            SELECT
            ...
            " . $this->CreateSQL();
        $sth = dbquery($query);
        include_once "./components/statics_filters.php";  
    }
    public function LinksReports($token){
        include_once "./components/links_reports.php";  
    }
