...
html_head(__('geoipupdate15'), 0, false, false);
html_body('other');
...
echo '<li class="breadcrumb-item title_page_li active">'.__('geoipupdate15').'</li>';
echo '</ol>';
echo ' <div class="d-flex flex-column">';

echo '<div class="card card-wr">';
echo '    <div class="card-header card-header-warriors">';
echo '        <i class="fas fa-info mr-1"></i>';
echo __('geoipupdate15');
echo '    </div>';
