...
$name_mailscanner = "Engine";
$name_antivirus = "Antivirus";
$name_wdm = "WDM";
...
return array(
    ...
    'username' => 'User:',
    'password' => 'Password:',
    'mwloginpage01' => $name_wdm . ' - Login Page',
    'mwlogin01' => $name_wdm . ' Login',
    ...
    // 03-functions.php
    'administrations03' => 'Administration',
    'typeofmessages03' => 'Type of messages',
    ...
    'mailscanner03' => '' . $name_mailscanner . ':',
    'none03' => 'None',
    'yes03' => 'YES',
    'no03' => 'NO',
    'status03' => 'Status',
    ...
    'footer03' => $name_mailscanner . ' for Warriors Lab\'s ',
    'mailwatchtitle03' => '' . $name_wdm . ' for ' . $name_mailscanner . '',
    'radiospam203' => 'S',
    'radioham03' => 'H',
    'radioforget03' => 'F',
    'radiorelease03' => 'R',
    ...
    'ops03' => 'Options',
    'or03' => 'or',
    'mwfilterreport03' => '' . $name_wdm . ' Filter Report:',
    'mwforms03' => '' . $name_wdm . ' for ' . $name_mailscanner . ' - ',
    'dieerror03' => 'Error:',
    'dievirus03' => 'You are running ' . $name_wdm . ' in distributed mode therefore ' . $name_wdm . ' cannot read your ' . $name_mailscanner . ' configuration files to acertain your primary virus scanner - please edit functions.php and manually set the VIRUS_REGEX constant for your primary scanner.',
    ...
    'dienomsconf03' => 'Cannot open ' . $name_mailscanner . ' configuration file',
    ...
    'dietranslateetoi03' => 'Cannot open ' . $name_mailscanner . ' ConfigDefs file:',
    'diequarantine103' => 'Message ID',
    'diequarantine203' => 'not found.',
    'diequarantine303' => 'Cannot open quarantine dir:',
    'diereadruleset03' => 'Cannot open ' . $name_mailscanner . ' ruleset file',
    ...
    'auditlogspamtrained03' => '' . $name_mailscanner . ' was trained and reported on message %s as',
    'spamerrorcode0103' => '' . $name_mailscanner . ': error code',
    'spamerrorcode0203' => 'returned from ' . $name_mailscanner . ':',
    'spamassassin03' => '' . $name_mailscanner . ':',
    ...
    'unknownvirusscanner03' => 'Unknown virus scanner defined in ' . $name_mailscanner . '.conf. Review your configuration and don\'t use \'auto\' as antivirus name (see FAQ).',
    'children03' => 'children',
    'procs03' => 'proc(s)',
    ...
    'mailweekgraph03' => 'Mails of the week',
    ...
    'saautolearn04' => '' . $name_mailscanner . ' Autolearn:',
    'sascore04' => '' . $name_mailscanner . ' Score:',
    ...
    'virus04' => 'Virus:',
    'spam04' => 'Spam:',
    'spamassassinspam04' => '' . $name_mailscanner . ' Spam:',
    ...
    'report04' => 'Report:',
    'spamassassin04' => '' . $name_mailscanner . '',
    'spamassassinmcp04' => '' . $name_mailscanner . ' MCP',
    ...
    'seconds05' => 'seconds',
    // status added blacklist and whitelist
    'error_options_05' => 'No options selected.',
    'error_selected_mail_05' => 'No messages selected.',
    'error_unexpected_05' => 'There was an unexpected error.',
    'success_added_wb1_05' => 'Added to ',
    'success_added_wb2_05' => ' successfully.',
    ...
    'issaspam09' => 'is Spam according to ' . $name_mailscanner . ' (>0 = TRUE)',
    ...
    'sascore09' => '' . $name_mailscanner . ' Score',
    'spamreport09' => 'Spam Report',
    'ismcp09' => 'is MCP (>0 = TRUE)',
    'ishighmcp09' => 'is High Scoring MCP (>0 = TRUE)',
    'issamcp09' => 'is MCP according to ' . $name_mailscanner . ' (>0 = TRUE)',
    ...
    'hostname09' => '' . $name_mailscanner . ' Hostname',
    'remove09' => 'Remove',
    'reports09' => 'Reports',
    ...
    'avclamavstatus10' => '' . $name_antivirus . ' Status',
    'avmcafeestatus10' => 'McAfee Status',
    'avfprotstatus10' => 'F-Prot Status',
    'mysqldatabasestatus10' => 'MySQL Database Status',
    'viewconfms10' => 'View ' . $name_mailscanner . ' Configuration',
    'editmsrules10' => 'Edit ' . $name_mailscanner . ' Rulesets',
    'spamassassinbayesdatabaseinfo10' => '' . $name_mailscanner . ' Bayes Database Info',
    'updatesadesc10' => 'Update ' . $name_mailscanner . ' Rule Descriptions',
    ...
    'mwandmsversion11' => '' . $name_wdm . ' and ' . $name_mailscanner . ' Version information',
    ...
    'input13' => 'Run Now',
    'updatesadesc13' => 'Update ' . $name_mailscanner . ' Rule Descriptions',
    'message113' => 'This utility is used to update the SQL database with up-to-date descriptions of the ' . $name_mailscanner . ' rules which are displayed on the Message Detail screen.',
    'message213' => 'This utility should generally be run after a ' . $name_mailscanner . ' update, however it is safe to run at any time as it only replaces the existing values and inserts only new values in the table (therefore preserving descriptions from potentially deprecated or removed rules).',
    'saruldesupdate13' => '' . $name_mailscanner . ' Rule Description Update',
    'rule13' => 'Rule',
    'description13' => 'Description',
    'auditlog13' => 'Ran ' . $name_mailscanner . ' Rules Description Update',
    ...
    'assassinscoredist14' => '' . $name_mailscanner . ' Score Distribution',
    'assassinrulhit14' => '' . $name_mailscanner . ' Rule Hits',
    ...
    // 18-bayes_info.php
    'spamassassinbayesdatabaseinfo18' => '' . $name_mailscanner . ' Bayes Database Info',
    ...
    'tokens18' => 'tokens',
    'auditlog18' => 'Viewed ' . $name_mailscanner . ' Bayes Database Info',
    'cannotfind18' => 'Error: Cannot find',
    'cleardbbayes18' => 'Clear Bayes Database',
    'auditlogwipe18' => 'Wiped out existing ' . $name_mailscanner . ' Bayes Database',
    'error18' => 'Error:',
    'clearmessage18' => 'Are you sure you want to clear the Bayes database?',

    // 19-clamav_status.php
    'avclamavstatus19' => '' . $name_antivirus . ' Status',
    'auditlog19' => 'Non-admin user attemped to view ' . $name_antivirus . ' Status page',
    ...
    'msconfig27' => '' . $name_mailscanner . ' Configuration',
    'auditlog27' => 'Viewed ' . $name_mailscanner . ' configuration',

    // 28-ms_lint.php
    'mailscannerlint28' => '' . $name_mailscanner . ' Lint',
    'diepipe28' => 'Cannot open pipe',
    'errormessage28' => 'The variable MS_EXECUTABLE_PATH is empty. Please set a value in conf.php.',
    'auditlog28' => 'Ran ' . $name_mailscanner . ' lint',
    ...
    'auditlog29' => 'Non-admin user attempted to view ' . $name_mailscanner . ' Rule Editor Page.',
    ...
    'sarulehits37' => '' . $name_mailscanner . ' Rule Hits',
    'rule37' => 'Rule',
    'desc37' => 'Description',
    'score37' => 'Score',
    'total37' => 'Total',
    ...
    'sascoredist38' => '' . $name_mailscanner . ' Score Distribution',
    ...
    // 51-sa_lint.php
    'salint51' => '' . $name_mailscanner . ' Lint',
    'diepipe51' => 'Cannot open pipe',
    'finish51' => 'Finish - Total Time',
    'auditlog51' => 'Ran ' . $name_mailscanner . ' lint',
    'message51' => 'Message',
    'time51' => 'Time',
    ...
    'nofind52' => 'Unable to find ' . $name_wdm . ' UID value',
    'nofindowner52' => 'Unable to find files or change files owner. Check directory contents of',
    'nosudoerfile52' => '' . $name_wdm . ' sudoer /etc/sudoers.d/mailwatch file not found, check and set right permission on GeoLite2 files in',
    ...
    'auditlog55' => 'Non-admin user attempted to view ' . $name_mailscanner . ' Rule Editor Page.',
    'msreedit55' => 'Edit ' . $name_mailscanner . ' Ruleset',
    'enable55' => 'Enable',
    'disable55' => 'Disable',
    ...
    'schedureloadmw55' => 'Scheduling reload of ' . $name_mailscanner . '...',
    'error0155' => 'ERROR: Couldn\'t schedule a reload of ' . $name_mailscanner . '! (You will have to manually do a reload of ' . $name_mailscanner . ' from system Shell)',
    'ok55' => 'Ok',
    'message55' => 'Your changes will take effect in the next %s minutes, when ' . $name_mailscanner . ' reloads.',
    ...
    'mailwatchtitle57' => '' . $name_wdm . ' for ' . $name_mailscanner . '',
    'result57' => 'Result',
    ...
    // 65 - Grey List
    'greylist65' => 'Grey list',
    'greywaiting65' => 'Waiting',
    'greyemailaddr65' => 'Email addresses',
    'greydomains65' => 'Domains',
    'greyoutdomain65' => 'Optout domain',
    'greyoutemail65' => 'Optout e-mail',
    'greyindomain65' => 'Optin domain',
    'greyinemail65' => 'Optin e-mail',

    'greyhostdomainlisted' => 'Greylisted hosts/domains',
    'greywaitingtitle65' => 'Hosts / domains that are currently greylisted',
    'greysendername65' => 'Sender name',
    'greysenderdomain65' => 'Sender domain',
    'greyipaddr65' => 'IP address',
    'greyrecipient65' => 'Recipient',
    'greyseenat65' => 'Seen at',
    'greyforgetselected65' => 'Forget (delete) selected entries',
    'greymoveselected65' => 'Move selected entries to whitelist ',

    'greywaitingdelete65' => 'Delete older than',
    'greyyear65' => 'Year',
    'greymonth65' => 'Month',
    'greyday65' => 'Day',
    'greyhour65' => 'Hour',
    'greyminute65' => 'Minutes',
    'greysecond65' => 'Seconds',

    'greyawlcardtitle65' => 'Auto-whitelisted (hosts / domains that have passed greylisting)',
    'greyawlsource65' => 'Source',
    'greyawllastseen65' => 'Last Seen',
    'greyawldeleteselected65' => 'Delete selected entries',
    'greyawlsourcecd65' => 'Source (class c or d)',
    'greyawldeleteudef65' => "Delete '-undef-' entries",

    'greyoptinouttitle165' => "Recipients for whom messages are never greylisted",
    'greyoptinouttitle265' => "Recipients for whom messages are never greylisted they are in the opt-out domain table",
    'greyoptinouttitle365' => "Recipients for whom messages are never greylisted they are in the opt-out email table",


    // 66 - RAM Dashboard
    'dashtotalram66' => 'Total Ram',
    'dashusedram66' => 'Used RAM',
    'dashavailableram66' => 'Available RAM',
    'dashserver66' => 'Server',
    'dashuptime66' => 'Uptime',
    'reportsmonth66' => 'Charts of the last month',

    // 67 - Mysql Status
    'mysqltablestatus67' => 'Table status',
    'mysqlprocesslist67' => 'Full Process list',
    'mysqlvariables67' => 'Variables',

    // 68 - Modal Search
    'modal_search_input68' => 'Search',
    'modal_search_msg68' => 'Search messages...',
    'modal_no_results68' => 'No results...',

    // 69 - mcp.php
    'mcp_subject69' => 'MCP Subject',
    'mcp_body69' => 'MCP Body',
    'mcp_phrases69' => 'Phrases',
    'mcp_description69' => 'Description',
    'mcp_score69' => 'Score',

    // 70 - services.php
    'services_running70' => 'Running',
    'services_stopped70' => 'Stopped',
    'services_reload70' => 'Reload',
    'services_status70' => 'Status',
    'services_start70' => 'Start',
    'services_stop70' => 'Stop',
    'services_repair70' => 'Repair',
    'services_mta70' => 'MTA',
    'services_engine70' => 'Engine',
    'services_database70' => 'Database',
    'services_score70' => 'Score',
    ...
    'message299' => 'is readable and writable by ' . $name_wdm . '',
    'mwlogo99' => '' . $name_wdm . ' Logo',
    'mslogo99' => '' . $name_mailscanner . ' Logo',
    ...
    'permissionsdenied99' => 'Permissions denied.',
);
