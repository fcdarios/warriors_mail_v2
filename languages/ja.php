...
return array(
    ...
    'username' => 'ユーザ:',
    'password' => 'パスワード:',
    'mwloginpage01' => '' . $name_wdm . ' ログインページ',
    'mwlogin01' => '' . $name_wdm . ' ログイン',
    ...
    // 03-functions.php
    'administrations03' => '管理',
    'typeofmessages03' => 'メッセージのタイプ',
    ...
    'ops03' => 'オプション',
    'or03' => 'or',
    'mwfilterreport03' => 'Mai
    lWatch レポートのフィルタリング:',
    'mwforms03' => '' . $name_wdm . ' for ' . $name_mailscanner . ' - ',
    'dieerror03' => 'エラー:',

    'dievirus03' => '' . $name_wdm . ' を分散モードで実行しているため、' . $name_wdm . ' は ' . $name_mailscanner . ' の設定ファイルを読んでプライマリウイルススキャナを取得することができません - functions.php を編集してプライマリスキャナのVIRUS_REGEX定数を手動で設定してください。',
    ...
    'dieruleset03' => 'ルールセットファイルを開くこと
    ができません',
    'dienomsconf03' => '' . $name_mailscanner . ' 設定ファイルを開けません',
    ...
    'ldapgetconfvar403' => 'LDAPディレク
    トリにあります。',
    'dietranslateetoi03' => '' . $name_mailscanner . ' ConfigDefsファイルを開けません :',
    'diequarantine103' => 'メッセージID',
    'diequarantine203' => '見つかりませんでした。',
    'diequarantine303' => '隔離ディレクトリを開くことがで
    きません :',
    'diereadruleset03' => '' . $name_mailscanner . ' ルールセットファイルを開けません',
    ...
    'unknownvirusscanner03' => '' . $name_mailscanner . '.conf で未知のウイルススキャナが定義されています。設定を確認し、ウイルス対策名として  \'auto\' を使用しないでください（FAQを参照）。',
    'children03' => '子',
    'procs03' => 'proc(s)',
    ...
    'error_options_05' => '選択されたオプションはありません。',
    'error_selected_mail_05' => '選択されたメッセージがありません',
    'error_unexpected_05' => '予期せぬエラーが発生しました。',
    ...
    'report09' => 'ウイル
    スレポート',
    'hostname09' => '' . $name_mailscanner . ' ホスト名',
    'remove09' => '削除',
    'reports09' => 'レポート',
    ...
    'avclamavstatus10' => '' . $name_antivirus . ' ステータス',
    'avmcafeestatus10' => 'McAfee ステータス',
    'avfprotstatus10' => 'F-Prot ステータス',
    'mysqldatabasestatus10' => 'MySQL データベースステータ
    ス',
    'viewconfms10' => '' . $name_mailscanner . ' の設定を表示',

    'editmsrules10' => '' . $name_mailscanner . ' のルールセットを編集',
    ...
    'mwandmsversion11' => '' . $name_wdm . ' と ' . $name_mailscanner . ' のバージョン情報',
    ...
    'avclamavstatus19' => '' . $name_antivirus . ' 状態',
    'auditlog19' => '非管理者が ' . $name_antivirus . ' のステータスページを表示しようとしました',
    ...
    'msconfig27' => '' . $name_mailscanner . ' の設定',
    'auditlog27' => '閲覧した ' . $name_mailscanner . ' の設定',

    // 28-ms_lint.php

    'mailscannerlint28' => '' . $name_mailscanner . ' Lint',
    'diepipe28' => 'パイプを開くことができません',
    'errormessage28' => '変数 MS_EXE
    CUTABLE_PATH は空です。conf.php に値を設定してください。 ',
    'auditlog28' => '実行 ' . $name_mailscanner . ' lint',
    'finish28' => '完了 - 合計時間',
    'message28' => 'メッセージ',
    'time28' => '時刻',
    ...
    'auditlog29' => '管理者以外のユーザーが ' . $name_mailscanner . ' ルールエディタページを表示しようとしました。',
    ...
    'norread52' => '読み書きできません',
    'directory52' => 'ディレクトリ',
    'nofind52' => '' . $name_wdm . ' UID 値が見つかりません',
    ...
    'auditlog55' => '管理
    者以外のユーザーが ' . $name_mailscanner . ' ルールエディタページを表示しようとしました。',
    'msreedit55' => '' . $name_mailscanner . ' ルール編集',
    'enable55' => '有効',
    'disable55' => '無効にする',
    'description55' => '説明：',
    'action55' => 'アクション：',
    ...
    'schedureloadmw
    55' => '' . $name_mailscanner . ' のリロードスケジュール...',
    'error0155' => 'エラー：' . $name_mailscanner . 'のリロードをスケジュールできませんでした！（システムシェルから ' . $name_mailscanner . ' を手動でリロードする必要があります） ',
    'ok55' => 'OK',

    'message55' => 'あなたの変更は、' . $name_mailscanner . ' がリロードする次の %s 分で有効になります。',
    ...
    'closewindow57' => '
    ウィンドウを閉じる',
    'mailwatchtitle57' => '' . $name_mailscanner . ' for ' . $name_mailscanner . '',
    'result57' => '結果',
    'delete57' => '削除：本当ですか？',
    'yes57' => 'はい',
    'no57' => 'いいえ',
    ...
    // 65 - Grey List
    'greylist65' => '灰色のリスト',
    'greywaiting65' => '待っています',
    'greyemailaddr65' => 'メールアドレス',
    'greydomains65' => 'ドメイン',
    'greyoutdomain65' => 'オプトアウトドメイン',
    'greyoutemail65' => 'オプトアウトメール',
    'greyindomain65' => 'オプトインドメイン',
    'greyinemail65' => 'オプトインメール',

    'greyhostdomainlisted' => 'グレーリストに登録されたホスト/ドメイン',
    'greywaitingtitle65' => '現在グレーリストに登録されているホスト/ドメイン',
    'greysendername65' => '送信者名',
    'greysenderdomain65' => '送信者ドメイン',
    'greyipaddr65' => 'IPアドレス',
    'greyrecipient65' => '受信者',
    'greyseenat65' => 'で見られる',
    'greyforgetselected65' => '選択したエントリを忘れる（削除する）',
    'greymoveselected65' => '選択したエントリをホワイトリストに移動します',

    'greywaitingdelete65' => 'より古いものを削除する',
    'greyyear65' => '年',
    'greymonth65' => '月',
    'greyday65' => '日',
    'greyhour65' => '時',
    ...
    'greyawlcardtitle65' => '自動ホワイトリスト（グレーリストに合格したホスト/ドメイン）',
    'greyawlsource65' => 'ソース',
    'greyawllastseen65' => '最後に見たのは',
    'greyawldeleteselected65' => '選択したエントリを削除します',
    'greyawlsourcecd65' => 'ソース（クラスcまたはd)',
    'greyawldeleteudef65' => "'-undef-'エントリを削除します",

    'greyoptinouttitle165' => "メッセージがグレーリストに登録されない受信者",
    'greyoptinouttitle265' => "メッセージがグレーリストに登録されない受信者は、オプトアウトドメインテーブルに含まれます",
    'greyoptinouttitle365' => "メッセージがグレーリストに登録されない受信者は、オプトアウト電子メールテーブルにあります",

    // 66 - RAM Dashboard
    'dashtotalram66' => 'トータルラム',
    'dashusedram66' => '使用済みRAM',
    'dashavailableram66' => '利用可能なRAM',
    'dashserver66' => 'サーバ',
    'dashuptime66' => '稼働時間',
    'reportsmonth66' => '先月のチャート',

   // 67 - Mysql Status
   'mysqltablestatus67' => 'テーブルのステータス',
   'mysqlprocesslist67' => '完全なプロセスリスト',
   'mysqlvariables67' => '変数',


    // 68 - Modal Search
    'modal_search_input68' => '探す',
    'modal_search_msg68' => 'メッセージを検索する',
    'modal_no_results68' => '結果がありません',

    // 69 - mcp.php
    'mcp_subject69' => 'MCP Subject',
    'mcp_body69' => 'MCP Body',
    'mcp_phrases69' => 'フレーズ',
    'mcp_description69' => '説明',
    'mcp_score69' => 'スコア',
    ...
    'message299' => 'は ' . $name_wdm . ' によって読み書き可能です',
    'mwlogo99' => '' . $name_wdm . ' ロゴ',

    'mslogo99' => '' . $name_mailscanner . ' ロゴ',
    ...
    'permissionsdenied99' => '権限が拒否されました。',
);
