...
if ($_SESSION['user_type'] !== 'A') {
    ...
    html_head(__('auditlog33'), 0, false, false);
    ...
    echo '<li class="breadcrumb-item title_page_li active">'.__('auditlog33').'</li>';
    echo '</ol>';
 ...
 <div class="card-body m-0 p-3">
  ...
  <form action="rep_audit_log.php" method="POST" class="floatleft">' . "\n";
    ...
    echo '<div class="mail table" id="auditFilters">
      <div class="row mt-2"><div class="col-sm-2 ">' . __('startdate33') . '</div><div class="cell data"><input class="form-control w-input-text" name="startDate" type="date" value="' . $startDate . '"/></div></div>
      <div class="row mt-2"><div class="col-sm-2 ">' . __('enddate33') . '</div><div class="cell data"><input class="form-control w-input-text" name="endDate" type="date" value="' . $endDate . '"/></div></div>
      <div class="row mt-2"><div class="col-sm-2 ">' . __('user33') . '</div><div class="cell data"><input class="form-control w-input-text" name="username" type="text" value="' . $username . '"/></div></div>
      <div class="row mt-2"><div class="col-sm-2 ">' . __('ipaddress33') . '</div><div class="cell data"><input class="form-control w-input-text" name="ipaddress" type="text" value="' . $ipaddress . '"/></div></div>
      <div class="row mt-2"><div class="col-sm-2 ">' . __('action33') . '</div><div class="cell data"><input class="form-control w-input-text" name="actions" type="text" value="' . $actions . '"/></div></div>
      <div class="row mt-2"><div class="col-sm-2 "></div><div class="cell head"><button class="btn btn-wr-red font-weight-bold btn-sm" type="submit">' . __('applyfilter33') . '</button></div></div>
    </div>
  </form>
</div></div>'. "\n";

    // Function to to query and display the data
    dbtable_v2($sql, __('auditlog33'), true, false,'wr-tableaudit');
