...
$filter = html_head(__('messlisting16'), 0, false, false);
...
echo '<div class="container-fluid">';
   ...
   echo '<li class="breadcrumb-item title_page_li active">'.__('messlisting16').'</li>';
   echo '</ol>';
echo '<div class="row">';
...
db_colorised_table_vDatable($sql, __('messlisting16'), true, true);
