...
$filter = html_head(__('virusreport50'), 0, false, true);
html_body('reports');
...
echo '<li class="breadcrumb-item title_page_li active">'.__('virusreport50').'</li>';
echo '</ol>';
...
<div class="col-xl-12">
    <div class="card card-wr">
      <div class="card-header card-header-warriors">
         ...
         <?php echo __('totalmailprocdate49'); ?>
      </div>
      <div class="card-body card-body-warriors"> 
         <?php
            
            // HTML Code
            echo '<table class="table table-sm table-striped table-wr" style="width:100%" id="tables-rep" cellspacing="0">';
            echo '<thead class="">';
            echo '<TR>';
