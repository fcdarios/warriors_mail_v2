...
if ($_SESSION['user_type'] !== 'A') {
    ...
    html_head(__('saruldesupdate13'), 0, false, false);
    ...
    echo '<li class="breadcrumb-item title_page_li active">'.__('saruldesupdate13').'</li>';
    echo '</ol>';
    ...
    echo  __('message113') . '<br>';
    echo '   <br>';
    echo '   ' . __('message213') . '<br><br>';

    echo '  <form method="post" action="sa_rules_update.php">
                <div>' . "\n";
    echo '          <input class="btn btn-sm btn-wr-red" type="submit" value="' . __('input13') . '"><br><br>';
