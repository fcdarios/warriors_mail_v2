...
echo '<div class="container-fluid">';
   ...
   echo '<li class="breadcrumb-item title_page_li">'.__('recentmessages03').'</li>';
   echo '</ol>';

echo ' <div class="d-flex flex-column">';
db_colorised_table_v2($sql, __('last05') . ' ' . MAX_RESULTS . ' ' . __('messages05') . ' (' . __('refevery05') . " $refresh " . __('seconds05') . ')');
echo ' </div>';
echo '</div>';
