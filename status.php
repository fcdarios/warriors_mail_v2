...
$refresh = html_head(__('recentmsg05'), STATUS_REFRESH, false, false);
...
echo '<div class="container-fluid">';
   ...
   echo '<li class="breadcrumb-item title_page_li"><a href="status.php">'.__('recentmessages03').'</a></li>';
   echo '</ol>';

echo ' <div class="d-flex flex-column">';
db_colorised_table_v2($sql, __('last05') . ' ' . MAX_RESULTS . ' ' . __('messages05') . ' (' . __('refevery05') . " $refresh " . __('seconds05') . ')', false, false, false, true);
