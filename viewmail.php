...
html_head(__('msgviewer06'), 0, false, false);
html_body('status');

echo '<div class="container-fluid">';
   echo '<ol class="breadcrumb my-4 title_page">';
   echo '<li class="breadcrumb-item title_page_li">'.__('msgviewer06').'</li>';
   echo '</ol>';
echo '<div class="row">';
// ------------------------------------------
...
echo '<div class="card mb-4 w-100 bg">
...
function lazy($title, $val, $dohtmlentities = true)
{
   ...
   <td class="pt-2 pb-2 pl-2 wr-tableheading">' . $titleintl . '</td>
   <td class="pl-2">' . $v . '</td>
   </tr>' . "\n";
}
...
if (
    ...
    lazy(
        ...
        " <div class=\"row mr-2 align-items-center\">
                <div class=\"m-2\">
                    <a class=\"btn btn-sm btn-wr-red btn-block\"  href=\"javascript:void(0)\" onclick=\"do_action('" . $message->id . "','" . $_SESSION['token'] . "','release')\">" . __('releasemsg06') . "</a>
                </div>
                <div class=\"m-2\">       
                    <a class=\"btn btn-sm btn-wr-black btn-block\" href=\"javascript:void(0)\" onclick=\"do_action('" . $message->id . "','" . $_SESSION['token'] . "','delete')\">" . __('deletemsg06') . "</a>
                </div>
            </div>",
        false
    );
...
foreach ($mime_struct as $key => $part) {
    ...
    echo ' <tr class="wr-tabletr">' . "\n";
    echo '  <td colspan=2 class="pt-2 pb-2 pl-2 wr-tableheading">' . __('mymetype06') . ' ' . $type . '</td>' . "\n";
    ...
    switch ($type) {
        ...
        default:
            ...
            if (
                ...
                echo ' <div class="row mr-2 align-items-center">
                <div class="m-2"> <a class="btn btn-sm btn-wr-red btn-block" href="viewpart.php?token=' . $_SESSION['token'] . '&amp;id=' . $message_id . '&amp;part=' . $part->mime_id . '">Download</a> </div></div>';
            }
            echo '</div>';
            echo '  </td>';
